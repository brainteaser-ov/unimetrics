...
SECRET_KEY = "django-insecure-*q$@a0^zplmn2e7ba8=coflakk6*3&h!)a68dg_0*sc&1lp$bu"
DEBUG = True
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'gbshine20@gmail.com'  # Ваш email
EMAIL_HOST_PASSWORD = '615478pes'  # Пароль от вашего email